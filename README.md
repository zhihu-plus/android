...
[![GitHub release](https://img.shields.io/github/v/release/zhihu-plus/android)](https://github.com/zhihu-plus/android/releases)
...
[点我下载](https://github.com/zhihu-plus/android/releases)

[下载最新开发版本](https://github.com/zhihu-plus/android/releases/tag/nightly)
...
知乎上的回答和文章随时可能被删，再打开就只剩「你似乎来到了没有知识存在的荒原」。打开本地存档后，应用按你选的保存策略把问答写入本机 SQLite，以后还能自己读。不需要自建服务器，也可以和存档服务器同时使用、互不影响。
...
[![Contributors](https://ghcontrib.pages.dev/image?repo=zhihu-plus/android)](https://github.com/zhihu-plus/android/graphs/contributors)
