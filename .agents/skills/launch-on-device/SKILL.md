...
adb shell am start -n com.github.zhihuplus.lite/com.github.zly2006.zhihu.MainActivity
```
...
Expected output: `Starting: Intent { cmp=com.github.zhihuplus.lite/com.github.zly2006.zhihu.MainActivity }`
...
adb exec-out run-as com.github.zhihuplus.lite cat files/account.json \
...
adb shell run-as com.github.zhihuplus.lite sh -c 'cp /data/local/tmp/zhihu-account.json files/account.json && chmod 600 files/account.json'
...
adb shell am instrument -w \
  ...
  com.github.zhihuplus.lite.test/com.github.zly2006.zhihu.ZhihuInstrumentedTestRunner
```
...
**Symptom:**
```
Failure [INSTALL_FAILED_UPDATE_INCOMPATIBLE: Existing package com.github.zhihuplus.lite signatures do not match newer version]
```

**Solution:**
```bash
# Uninstall existing app first
adb uninstall com.github.zhihuplus.lite
...
adb -s <device-id> shell am start -n com.github.zhihuplus.lite/com.github.zly2006.zhihu.MainActivity
```
...
adb logcat --pid=$(adb shell pidof -s com.github.zhihuplus.lite)

# Clear app data and try again
adb shell pm clear com.github.zhihuplus.lite
adb shell am start -n com.github.zhihuplus.lite/com.github.zly2006.zhihu.MainActivity
```
...
adb shell dumpsys package com.github.zhihuplus.lite | grep -A 1 "android.intent.action.MAIN:"
...
adb shell pm path com.github.zhihuplus.lite
...
# Get app info
adb shell dumpsys package com.github.zhihuplus.lite
```
...
```bash
./gradlew assembleLiteDebug && adb install -r ./app/build/outputs/apk/lite/debug/app-lite-debug.apk && adb shell am start -n com.github.zhihuplus.lite/com.github.zly2006.zhihu.MainActivity
```
...
7. ✅ Is package name correct? → `com.github.zhihuplus.lite`
